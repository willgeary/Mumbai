...
////// MAIN INPUTS ///////
String directoryName = "mumbai";
String date = "2017-08-28";
String inputFile = "../gtfs/mumbai_train_bus_metro.csv";
int totalFrames = 14400;
Location center = new Location(19.039402,72.860298);
...
int maxVehicleCount;
float hscale = float(totalFrames) / float(width)*0.095;
...
void loadData() {
  ...
  for (TableRow row : tripTable.rows()) {
    String vehicle_type = row.getString("operator");
